...
```
Agent(
  prompt="Read /home/dzmitry/Coding/oxtest/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/dzmitry/Coding/oxtest/.claude/gsd-core/templates/SECURITY.md`

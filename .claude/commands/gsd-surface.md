...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/dzmitry/Coding/oxtest/.claude/.gsd-surface.json`
(sibling to `/home/dzmitry/Coding/oxtest/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/dzmitry/Coding/oxtest/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/dzmitry/Coding/oxtest/.claude/skills`).
...
`/home/dzmitry/Coding/oxtest/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/dzmitry/Coding/oxtest/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/dzmitry/Coding/oxtest/.claude/.gsd-surface.json`
Install profile marker: `/home/dzmitry/Coding/oxtest/.claude/.gsd-profile`
Skill dirs: `/home/dzmitry/Coding/oxtest/.claude/skills/gsd-*/`
Engine module: `/home/dzmitry/Coding/oxtest/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/dzmitry/Coding/oxtest/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>

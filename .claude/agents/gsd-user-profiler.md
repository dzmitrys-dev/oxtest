...
<reference>
@/home/dzmitry/Coding/oxtest/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/home/dzmitry/Coding/oxtest/.claude/gsd-core/references/user-profiling.md` to load:

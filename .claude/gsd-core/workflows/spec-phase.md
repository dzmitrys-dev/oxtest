...
ones). Reference: @/home/dzmitry/Coding/oxtest/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /home/dzmitry/Coding/oxtest/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/home/dzmitry/Coding/oxtest/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/home/dzmitry/Coding/oxtest/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/home/dzmitry/Coding/oxtest/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/home/dzmitry/Coding/oxtest/.claude/gsd-core/templates/spec.md.

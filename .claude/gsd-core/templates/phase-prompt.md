...
<!-- For checkpoint task examples and patterns, see @/home/dzmitry/Coding/oxtest/.claude/gsd-core/references/checkpoints.md -->
...
See `/home/dzmitry/Coding/oxtest/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/home/dzmitry/Coding/oxtest/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/home/dzmitry/Coding/oxtest/.claude/gsd-core/workflows/verify-phase.md` for verification logic.

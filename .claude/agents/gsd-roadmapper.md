...
Reference full template: `/home/dzmitry/Coding/oxtest/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/dzmitry/Coding/oxtest/.claude/gsd-core/templates/state.md`.

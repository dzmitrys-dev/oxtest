...
<required_reading>
@/home/dzmitry/Coding/oxtest/.claude/gsd-core/references/user-story-template.md
@/home/dzmitry/Coding/oxtest/.claude/gsd-core/references/spidr-splitting.md
@/home/dzmitry/Coding/oxtest/.claude/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/home/dzmitry/Coding/oxtest/.claude/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/home/dzmitry/Coding/oxtest/.claude/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@/home/dzmitry/Coding/oxtest/.claude/gsd-core/references/spidr-splitting.md`. Briefly:
